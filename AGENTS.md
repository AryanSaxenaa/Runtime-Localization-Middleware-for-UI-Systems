# Runtime UI Text Translator

Production-safe localization middleware for UI systems. Preserves placeholders, enforces tone, and integrates into CI/CD pipelines and MCP servers.
